...
/**
 * Represents an error for unimplemented methods.
 * This error should be thrown when a required method is not implemented in a class.
 *
 * @extends {ApplicationError}
 */
class MethodNotImplementedError extends ApplicationError {
  /**
   * Constructs a new instance.
   *
   * @param {string}           name   - The name of the method that is not implemented.
   * @param {{ name: string }} source - The object or class that lacks the implementation.
   */
  constructor(name, source) {
    super();

    /**
     * Descriptive message indicating the missing method and the source where it should
     * exist.
     *
     * @type {string}
     */
    this.message = `The method ${name} has not been implemented in ${source.name}.`;
  }
}

/**
 * Represents an error for unimplemented getters.
 * This error should be thrown when a required getter is not implemented in a class.
 *
 * @extends {ApplicationError}
 */
class GetterNotImplementedError extends ApplicationError {
  /**
   * Constructs a new instance.
   *
   * @param {string}           key    - The key of the getter that is not implemented.
   * @param {{ name: string }} source - The object or class that lacks the implementation.
   */
  constructor(key, source) {
    ...
    /**
     * Descriptive message indicating the missing getter and the source where it should
     * exist.
     *
     * @type {string}
     */
    this.message = `The getter ${key} has not been implemented in ${source.name}.`;
  }
}

export {
  ApplicationError,
  GetterNotImplementedError,
  HttpError,
